...
public class ArticleManager {
	...
	public void isValidArticle(Article article) throws BLLException {
		...
		LocalDate dateDebutPlus7Jours = article.getDateDebutEncheres().plusDays(6);
		if (!(dateDebutPlus7Jours.compareTo(article.getDateFinEncheres()) < 0))
			throw new BLLException(
					"La date de fin d'enchère doit être au minimum 7 jours supérieurs à la date de début d'enchère!");
