	...
	<div>
		...
		<form action="${pageContext.request.contextPath}/inscription"
			...
			<div class="form-group row">
				<label for="pseudo" class="col-2 col-form-label"><b>Pseudo
						: </b></label>
				<div class="col-10">
					<div class="input-group">
						...
						<input id="pseudo" name="pseudo" placeholder="pseudo" type="text"
			...
			<div class="col-12 d-flex justify-content-center">
				<div class="form-group d-flex justify-content-center">
					...
					<input id="nom" name="nom" type="text" required="required"
						value="${ utilisateur.getNom() }" class="form-control"> <label
						class="col-2 col-form-label" for="prenom"><b>Prénom :</b></label>
			...
			<div class="form-group row">
				<label for="email" class="col-2 col-form-label"><b>Email
						:</b></label>
				<div class="col-10">
					<div class="input-group">
						<div class="input-group-prepend">
						...
						<input id="email" name="email" placeholder="example@eni.com"
							type="text" required="required"
							value="${ utilisateur.getEmail() }" class="form-control">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				<label for="telephone" class="col-2 col-form-label"><b>Teléphone
						: </b></label>
				<div class="col-10">
					<div class="input-group">
						<div class="input-group-prepend">
						...
						<input id="telephone" name="telephone" type="number"
							aria-describedby="HelpBlock" required="required"
							value="${ utilisateur.getTelephone() } " class="form-control">
					</div>
					<span id="HelpBlock" class="form-text text-muted">ex :
						0605040302</span>
				</div>
			</div>
			...
			<div class="form-group row">
				<label for="rue" class="col-2 col-form-label"><b>Adresse
						: </b></label>
				<div class="col-10">
					<div class="input-group">
						<div class="input-group-prepend">
			...
			<div class="form-group row">
				<label for="ville" class="col-2 col-form-label"><b>Ville
						: </b></label>
				<div class="col-10">
			...
			<div class="form-group row">
				<label for="code_postal" class="col-2 col-form-label"><b>Code
						postal</b></label>
				<div class="col-10">
			...
			<div class="form-group row">
				<label for="mot_de_passe" class="col-2 col-form-label"> <b>Mot
						de passe : </b></label>
				<div class="col-10">
					<div class="input-group">
						<div class="input-group-prepend">
			...
			<div class="form-group row">
				<label for="confirmation" class="col-2 col-form-label"><b>Confirmation
						du mot de passe</b></label>
				<div class="col-10">
